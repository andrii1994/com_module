...
class Com_Module_Block_Adminhtml_Catalog_Product_Edit_Tab_Options_Option extends Mage_Adminhtml_Block_Catalog_Product_Edit_Tab_Options_Option
{
    ...
    {
        parent::__construct();
        $this->setTemplate('com/catalog/product/edit/options/option.phtml');
...
//        $optionsArr = $this->getProduct()->getOptions();
        ...
        if (!$this->_values) {
            ...
            foreach ($optionsArr as $option) {
                ...
                // ==== CUSTOM 'tooltip_text' ====
                $value['tooltip_text'] = $option->getTooltipText();
