 ...
 */
class Com_Module_Block_Catalog_Product_View_Options_Type_Select
    ...
    public function getValuesHtml()
    {
        ...
        if ($_option->getType() == Mage_Catalog_Model_Product_Option::OPTION_TYPE_DROP_DOWN
            ...
            foreach ($_option->getValues() as $_value) {
                // === CUSTOM ===
                if (Mage::getStoreConfig('com_module/com_module_group/com_module_price_select', Mage::app()->getStore())) {
